...
- Use of wildcards to increase API flexibility
	...
	- Upper Bounded Wildcards - **? extends Type**
		- restricts the unknown type to be a specific type or sub-type. As explained in [PlayWithUpperBoundedWildCard](src/main/java/com/pankiba/generics/boundedwildcards/PlayWithUpperBoundedWildCard.java), function **sumOfList** can accept Number and its sub types
